...
//     searchParams: { [key: string]: string | string[] | undefined };  // @typescript-eslint/no-unused-vars
// };
...
// export default async function UserProfilePage({ params, searchParams }: PageProps) {  // eslint-disable-line @typescript-eslint/no-unused-vars
//     try {
