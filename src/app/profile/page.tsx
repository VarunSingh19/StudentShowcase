...
//                                     />
//                                 ))}
//                                 {projects.filter(project => project.approved).length === 0 && (
//                                     <p className="text-muted-foreground text-center py-4">
...
//             <ProfileTabs profile={profile} setProfile={setProfile} projects={projects} />
//         </div>
//     )
// }
...
//                 userId: user.uid,
//                 updatedAt: new Date(),
//                 starredProjectId: profile.starredProjectId || null,
//             }, { merge: true })
//         } catch (err) {
//             console.error('Error saving profile:', err)
//             setError('Failed to save profile')
...
// import { Alert, AlertDescription } from "@/components/ui/alert"
// import { Badge } from "@/components/ui/badge"
// import { Github, Linkedin, Twitter, Globe, Loader2, Heart } from 'lucide-react'
// import type { UserProfile } from '@/types/profile'
// import { Certificate } from '@/components/Certificate'
// import { ProfileHeader } from './ProfileHeader'
...
//                 return {
//                     id: doc.id,
//                     projectName: projectData.projectName || 'Untitled Project', // Default if missing
...
//     return (
//         <div className="container max-w-4xl mx-auto px-4 py-8">
//             <div className=" bg-gradient-to-br from-background to-secondary/20">
//                 <ProfileHeader
//                     profile={profile}
...
//                         <CardContent>
//                             <div className="mb-4">
//                                 <h3 className="text-lg font-semibold">Total Likes: {totalLikes}</h3>
//                             </div>
//                             <div className="grid gap-4">
//                                 {projects.map((project) => (
//                                     <div
...
//             if (!updatedSkills.includes(skillInput.trim())) {
//                 updatedSkills.push(skillInput.trim());
...
//                         updatedAt: new Date(),
//                     }, { merge: true });
//                     setSkillError(''); // Clear error if successful
//                 } catch (err) {
//                     console.error('Error saving skills:', err);
//                     setSkillError('Failed to save skills');
//                 }
//             }
//             setSkillInput('');
//         }
...
// import { Alert, AlertDescription } from "@/components/ui/alert"
// import { Badge } from "@/components/ui/badge"
// import { Github, Linkedin, Twitter, Globe, Loader2, Heart, Briefcase, MapPin, Mail, Phone, Star, Code, Award, BookOpen, Smile, Download, Eye, Edit, Trash2 } from 'lucide-react'
// import type { UserProfile } from '@/types/profile'
// import { Certificate } from '@/components/Certificate'
// import { ProfileHeader } from './ProfileHeader'
// import { TaskList } from '@/components/TaskList'
...
//                 <TabsContent value="projects">
//                     <ProjectsContent projects={projects} totalLikes={totalLikes} />
//                 </TabsContent>
...
//                             placeholder="Type a skill and press Enter"
//                         />
//                         <Button onClick={() => handleAddSkill({ key: 'Enter' } as React.KeyboardEvent)} type="button">
//                             Add
//                         </Button>
//                     </div>
//                     <div className="flex flex-wrap gap-2 mt-2">
...
// import { Alert, AlertDescription } from "@/components/ui/alert"
// import { Badge } from "@/components/ui/badge"
// import { Github, Linkedin, Twitter, Globe, Loader2, Heart, Briefcase, MapPin, Mail, Phone, Star, Code, Award, BookOpen, Smile, Download, Eye } from 'lucide-react'
// import type { UserProfile } from '@/types/profile'
// import { Certificate } from '@/components/Certificate'
// import { ProfileHeader } from './ProfileHeader'
...
// import { LikedProjectsSection } from './LikedProjectSection'
...
//                 <TabsContent value="liked">
//                     <LikedProjectsSection likedProjects={likedProjects} />
//                 </TabsContent>

//                 <TabsContent value="certificates">
//                     <CertificateSection projects={projects.filter(p => p.approved)} profile={profile as UserProfile} />
//                 </TabsContent>
