            ...
            <Card className="w-full max-w-3xl mx-auto relative border-2 shadow-lg">
                ...
                <div className="absolute -right-4 -top-4 w-32 h-32 transform rotate-12 mix-blend-multiply">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                        ...
                        <circle cx="100" cy="100" r="80" fill="none" stroke="#166534" strokeWidth="2" />

                        <path id="stamp-circle" d="M100,30 A70,70 0 1 1 99.99,30" fill="none" stroke="none" />
                ...
                <CardHeader className="text-center border-b pb-6">
                    ...
                    <CardDescription className="text-lg mt-2">Issued by StudentShowcase</CardDescription>
                </CardHeader>
                ...
                <CardContent className="pt-8">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-500">
                            This certificate verifies the successful completion and verification of the project on the StudentShowcase
                            platform.
                        </p>
                    </div>
                </CardContent>
