          ...
          {(
            ...
            <div key={section}>
              ...
              <div className="space-y-2">
                ...
                >
                  <PlusIcon className="h-4 w-4 mr-2 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 animate-gradient-x" />{" "}
                  Add{" "}
                  {section
                    .replace(/([A-Z])/g, " $1")
                    .replace(/^./, (str) => str.toUpperCase())}
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-8">
      ...
      <h1 className="text-2xl font-bold mb-4">
        StudentShowcaseAi Task Manager
      </h1>
      <p>
        This is a simple task manager for managing tasks and generating project
        plans using StudentShowcaseAI. You can add, edit, and delete tasks, and
        generate project plans for each task.
      </p>
