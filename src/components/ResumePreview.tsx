...
//                 <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6 flex items-center space-x-6">
//                     <ImageModal
//                         src={profile.avatarUrl || `/studentshowcase.jpg?text=${profile.displayName?.charAt(0) || 'U'}`}
...
//                             </h2>
//                             <div className="flex items-center text-sm opacity-80">
//                                 {profile.socialLinks.github || profile.socialLinks.linkedin || profile.socialLinks.portfolio || profile.socialLinks.twitter ? (
//                                     <>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex space-x-3 mt-4">
                                                ...
                                                <Dialog>
                                                    ...
                                                    <DialogContent className="max-w-3xl">
                                                        <DialogTitle>
                                                            {profile.displayName} Certificate Preview
                                                        </DialogTitle>
                                                        <CertificatePreview
                                                            projectName={project.projectName}
                                                            recipientName={profile.displayName}
